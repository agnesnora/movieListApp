...
const ButtonComponent = /*#__PURE__*/forwardRef(({
  ...
  var _props$leadingVisual, _props$trailingVisual;
  let sxStyles = sxProp;
  const leadingVisual = (_props$leadingVisual = props.leadingVisual) !== null && _props$leadingVisual !== void 0 ? _props$leadingVisual : props.leadingIcon;
  const trailingVisual = (_props$trailingVisual = props.trailingVisual) !== null && _props$trailingVisual !== void 0 ? _props$trailingVisual : props.trailingIcon;
...
function generateCustomSxProp(props, providedSx) {
  ...
  const noVisuals = props.leadingVisual || props.trailingVisual || props.trailingAction ? '' : '[data-no-visuals="true"]';
