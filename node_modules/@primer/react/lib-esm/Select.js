...
const Select = /*#__PURE__*/React__default.forwardRef(({
  ...
  validationStatus,
  ...rest
}, ref) => /*#__PURE__*/React__default.createElement(TextInputWrapper, {
  sx: {
    overflow: 'hidden',
    position: 'relative',
...
}, /*#__PURE__*/React__default.createElement(StyledSelect, _extends({
  ref: ref,
  required: required,
  disabled: disabled,
  ...
  disabled: required,
  hidden: required
}, placeholder), children), /*#__PURE__*/React__default.createElement(ArrowIndicator, null)));
