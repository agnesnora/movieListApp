...
[data-color-mode="auto"][data-light-theme="light_high_contrast"] {
  ...
  --control-fgColor-disabled: #4b535d;
  --control-borderColor-rest: #20252c;
  --control-borderColor-emphasis: #20252c;
  --control-borderColor-disabled: #e7ecf0;
  ...
  --control-checked-bgColor-disabled: #4b535d;
  ...
  --button-default-bgColor-disabled: #e7ecf0;
  ...
  --button-invisible-fgColor-disabled: #4b535d;
  --button-invisible-iconColor-rest: #0e1116;
  --button-invisible-iconColor-hover: #ffffff;
  --button-invisible-iconColor-disabled: #4b535d;
  ...
  --button-invisible-borderColor-disabled: #e7ecf0;
  ...
  --fgColor-link: #023b95;
  --fgColor-link-onInverse: #67b3fd;
  --fgColor-neutral: #66707b;
  --fgColor-neutral-onInverse: #ced5dc;
  --fgColor-accent: #023b95;
  --fgColor-accent-onInverse: #67b3fd;
  --fgColor-success: #055d20;
  --fgColor-success-onInverse: #43c663;
  --fgColor-attention: #744500;
  --fgColor-attention-onInverse: #d5a824;
  --fgColor-severe: #873800;
  --fgColor-severe-onInverse: #f99636;
  --fgColor-danger: #8a071e;
  --fgColor-danger-onInverse: #ff8e8a;
  --fgColor-open: #055d20;
  --fgColor-open-onInverse: #43c663;
  --fgColor-closed: #8a071e;
  --fgColor-closed-onInverse: #ff8e8a;
  --fgColor-done: #622cbc;
  --fgColor-done-onInverse: #c49bff;
  --fgColor-sponsors: #971368;
  --fgColor-sponsors-onInverse: #fc87ca;
  ...
  --shadow-floating-medium: 0px 8px 16px -4px #343b4314, 0px 4px 32px -4px #343b4314, 0px 24px 48px -12px #343b4314, 0px 48px 96px -24px #343b4314;
  --shadow-floating-large: 0px 40px 80px 0px #343b433d;
  --shadow-floating-xlarge: 0px 56px 112px 0px #343b4352;
}
