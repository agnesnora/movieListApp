...
[data-color-mode="auto"][data-light-theme="dark_colorblind"] {
  ...
  --color-scale-red-0: #ffdfb6;
  --color-scale-red-1: #ffc680;
  --color-scale-red-2: #ffa657;
  --color-scale-red-3: #f0883e;
  --color-scale-red-4: #db6d28;
  --color-scale-red-5: #bd561d;
  --color-scale-red-6: #9b4215;
  --color-scale-red-7: #762d0a;
  --color-scale-red-8: #5a1e02;
  --color-scale-red-9: #3d1300;
