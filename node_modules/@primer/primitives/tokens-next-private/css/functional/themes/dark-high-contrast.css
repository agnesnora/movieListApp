...
[data-color-mode="auto"][data-light-theme="dark_high_contrast"] {
  ...
  --control-fgColor-disabled: #bdc4cc;
  --control-borderColor-rest: #7a828e;
  --control-borderColor-emphasis: #7a828e;
  --control-borderColor-disabled: #272b33;
  ...
  --control-checked-bgColor-disabled: #bdc4cc;
  ...
  --controlKnob-bgColor-disabled: #272b33;
  --controlKnob-bgColor-checked: #ffffff;
  --controlKnob-borderColor-rest: #7a828e;
  --controlKnob-borderColor-disabled: #272b33;
  ...
  --shadow-floating-small: 0px 0px 0px 1px #272b33, 0px 6px 12px -3px #01040966, 0px 6px 18px 0px #01040966;
  --shadow-floating-medium: 0px 0px 0px 1px #272b33, 0px 8px 16px -4px #01040966, 0px 4px 32px -4px #01040966, 0px 24px 48px -12px #01040966, 0px 48px 96px -24px #01040966;
  --shadow-floating-large: 0px 0px 0px 1px #272b33, 0px 24px 48px 0px #010409;
  --shadow-floating-xlarge: 0px 0px 0px 1px #272b33, 0px 32px 64px 0px #010409;
