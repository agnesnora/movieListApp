...
$fgColor-success-onInverse: #1f6feb;
...
$fgColor-open: #f0883e;
$fgColor-open-onInverse: #bd561d;
$fgColor-closed: #8b949e;
$fgColor-closed-onInverse: #484f58;
$fgColor-done: #a371f7;
...
$color-scale-red-0: #ffdfb6; // Avoid using scales, use other functional tokens instead
$color-scale-red-1: #ffc680; // Avoid using scales, use other functional tokens instead
$color-scale-red-2: #ffa657; // Avoid using scales, use other functional tokens instead
$color-scale-red-3: #f0883e; // Avoid using scales, use other functional tokens instead
$color-scale-red-4: #db6d28; // Avoid using scales, use other functional tokens instead
$color-scale-red-5: #bd561d; // Avoid using scales, use other functional tokens instead
$color-scale-red-6: #9b4215; // Avoid using scales, use other functional tokens instead
$color-scale-red-7: #762d0a; // Avoid using scales, use other functional tokens instead
$color-scale-red-8: #5a1e02; // Avoid using scales, use other functional tokens instead
$color-scale-red-9: #3d1300; // Avoid using scales, use other functional tokens instead
