...
$control-borderColor-disabled: #f6f8fa;
...
$button-invisible-borderColor-disabled: #f6f8fa;
...
$fgColor-onInverse: #f6f8fa;
$fgColor-disabled: #8c959f;
$fgColor-link: #0969da;
$fgColor-link-onInverse: #54aeff;
$fgColor-neutral: #6e7781;
$fgColor-neutral-onInverse: #8c959f;
$fgColor-accent: #0969da;
$fgColor-accent-onInverse: #54aeff;
$fgColor-success: #0969da;
$fgColor-success-onInverse: #54aeff;
$fgColor-attention: #9a6700;
$fgColor-attention-onInverse: #d4a72c;
$fgColor-severe: #cf222e;
$fgColor-severe-onInverse: #ff8182;
$fgColor-danger: #d1242f;
$fgColor-danger-onInverse: #fa4549;
$fgColor-open: #cf222e;
$fgColor-open-onInverse: #fa4549;
$fgColor-closed: #6e7781;
$fgColor-closed-onInverse: #afb8c1;
$fgColor-done: #8250df;
$fgColor-done-onInverse: #a475f9;
$fgColor-sponsors: #bf3989;
$fgColor-sponsors-onInverse: #e85aad;
...
$color-scale-orange-0: #ffebe9; // Avoid using scales, use other functional tokens instead
$color-scale-orange-1: #ffcecb; // Avoid using scales, use other functional tokens instead
$color-scale-orange-2: #ffaba8; // Avoid using scales, use other functional tokens instead
$color-scale-orange-3: #ff8182; // Avoid using scales, use other functional tokens instead
$color-scale-orange-4: #fa4549; // Avoid using scales, use other functional tokens instead
$color-scale-orange-5: #cf222e; // Avoid using scales, use other functional tokens instead
$color-scale-orange-6: #a40e26; // Avoid using scales, use other functional tokens instead
$color-scale-orange-7: #82071e; // Avoid using scales, use other functional tokens instead
$color-scale-orange-8: #660018; // Avoid using scales, use other functional tokens instead
$color-scale-orange-9: #4c0014; // Avoid using scales, use other functional tokens instead
...
$shadow-floating-small: 0px 6px 12px -3px #424a530a, 0px 6px 18px 0px #424a531f;
$shadow-floating-medium: 0px 8px 16px -4px #424a5314, 0px 4px 32px -4px #424a5314, 0px 24px 48px -12px #424a5314, 0px 48px 96px -24px #424a5314;
$shadow-floating-large: 0px 40px 80px 0px #424a533d;
$shadow-floating-xlarge: 0px 56px 112px 0px #424a5352;
