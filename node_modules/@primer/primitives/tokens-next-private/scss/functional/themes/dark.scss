...
$control-checked-bgColor-disabled: #8b949e;
...
$control-checked-borderColor-disabled: #8b949e;
...
$controlKnob-bgColor-disabled: #161b22;
$controlKnob-bgColor-checked: #ffffff;
$controlKnob-borderColor-rest: #666e79;
$controlKnob-borderColor-disabled: #161b22;
...
$fgColor-link: #2f81f7;
$fgColor-link-onInverse: #1f6feb;
$fgColor-neutral: #6e7681;
$fgColor-neutral-onInverse: #484f58;
$fgColor-accent: #2f81f7;
$fgColor-accent-onInverse: #1f6feb;
$fgColor-success: #3fb950;
$fgColor-success-onInverse: #238636;
$fgColor-attention: #d29922;
$fgColor-attention-onInverse: #9e6a03;
$fgColor-severe: #db6d28;
$fgColor-severe-onInverse: #bd561d;
$fgColor-danger: #f85149;
$fgColor-danger-onInverse: #db3734;
$fgColor-open: #3fb950;
$fgColor-open-onInverse: #238636;
$fgColor-closed: #f85149;
$fgColor-closed-onInverse: #db3734;
$fgColor-done: #a371f7;
$fgColor-done-onInverse: #8957e5;
$fgColor-sponsors: #db61a2;
$fgColor-sponsors-onInverse: #bf4b8a;
...
$color-scale-green-0: #aff5b4; // Avoid using scales, use other functional tokens instead
$color-scale-green-1: #7ee787; // Avoid using scales, use other functional tokens instead
$color-scale-green-2: #56d364; // Avoid using scales, use other functional tokens instead
$color-scale-green-3: #3fb950; // Avoid using scales, use other functional tokens instead
$color-scale-green-4: #2ea043; // Avoid using scales, use other functional tokens instead
$color-scale-green-5: #238636; // Avoid using scales, use other functional tokens instead
$color-scale-green-6: #196c2e; // Avoid using scales, use other functional tokens instead
$color-scale-green-7: #0f5323; // Avoid using scales, use other functional tokens instead
$color-scale-green-8: #033a16; // Avoid using scales, use other functional tokens instead
$color-scale-green-9: #04260f; // Avoid using scales, use other functional tokens instead
...
$color-scale-orange-0: #ffdfb6; // Avoid using scales, use other functional tokens instead
$color-scale-orange-1: #ffc680; // Avoid using scales, use other functional tokens instead
$color-scale-orange-2: #ffa657; // Avoid using scales, use other functional tokens instead
$color-scale-orange-3: #f0883e; // Avoid using scales, use other functional tokens instead
$color-scale-orange-4: #db6d28; // Avoid using scales, use other functional tokens instead
$color-scale-orange-5: #bd561d; // Avoid using scales, use other functional tokens instead
$color-scale-orange-6: #9b4215; // Avoid using scales, use other functional tokens instead
$color-scale-orange-7: #762d0a; // Avoid using scales, use other functional tokens instead
$color-scale-orange-8: #5a1e02; // Avoid using scales, use other functional tokens instead
$color-scale-orange-9: #3d1300; // Avoid using scales, use other functional tokens instead
...
$shadow-resting-small: 0px 1px 0px 0px #01040966, 0px 1px 3px 0px #01040966;
$shadow-resting-medium: 0px 3px 6px 0px #010409cc;
$shadow-floating-small: 0px 0px 0px 1px #161b22, 0px 6px 12px -3px #01040966, 0px 6px 18px 0px #01040966;
$shadow-floating-medium: 0px 0px 0px 1px #161b22, 0px 8px 16px -4px #01040966, 0px 4px 32px -4px #01040966, 0px 24px 48px -12px #01040966, 0px 48px 96px -24px #01040966;
$shadow-floating-large: 0px 0px 0px 1px #161b22, 0px 24px 48px 0px #010409;
$shadow-floating-xlarge: 0px 0px 0px 1px #161b22, 0px 32px 64px 0px #010409;
